...
class FollowAdapter : ListAdapter<FavoriteUserResponse, FollowAdapter.MyViewHolder>(DIFF_CALLBACK) {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            intentDetail.putExtra("arif", github.login)
            holder.itemView.context.startActivity(intentDetail)
        }
    }

    class MyViewHolder(private val binding: ItemGithubBinding) :
